      ...
      <div className="container px-4">
        ...
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className=" ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial wow fadeInUp " data-wow-delay=".1s " >
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className=" ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial wow fadeInUp " data-wow-delay=".15s " >
              <div className="ud-testimonial-ratings flex items-center mb-3">
                <span className="text-[#fbb040] mr-1">
                  <svg width="18" height="16" viewBox="0 0 18 16" className="fill-current" >
                    <path
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className=" ud-single-testimonial p-8 bg-white mb-12 shadow-testimonial wow fadeInUp " data-wow-delay=".2s " >
              <div className="ud-testimonial-ratings flex items-center mb-3">
                <span className="text-[#fbb040] mr-1">
                  <svg width="18" height="16" viewBox="0 0 18 16" className="fill-current" >
                    <path
              ...
              <div className="ud-brands-logo flex items-center flex-wrap">
                <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a href="https://tailgrids.com" target="_blank" rel="nofollow noopner" >
                    <img src="/images/brands/tailgrids.svg" alt="tailgrids" className="grayscale hover:filter-none duration-300" />
                  </a>
                </div>
                <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a href="https://ayroui.com" target="_blank" rel="nofollow noopner" >
                    <img src="/images/brands/ayroui.svg" alt="ayroui" className="grayscale hover:filter-none duration-300" />
                  </a>
                </div>
                <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a href="https://uideck.com" target="_blank" rel="nofollow noopner" >
                    <img src="/images/brands/uideck.svg" alt="uideck" className="grayscale hover:filter-none duration-300" />
                  </a>
                </div>
                <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a href="https://graygrids.com" target="_blank" rel="nofollow noopner" >
                    <img src="/images/brands/graygrids.svg" alt="graygrids" className="grayscale hover:filter-none duration-300" />
                  </a>
                </div>
                <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a href="https://lineicons.com" target="_blank" rel="nofollow noopner" >
                    <img src="/images/brands/lineicons.svg" alt="lineicons" className="grayscale hover:filter-none duration-300" />
                  </a>
                </div>
              </div>
            </div>
