           ...
           <div className="flex flex-wrap -mx-4">
             <div className="w-full px-4">
               <div className="mb-12 lg:mb-20 max-w-[620px]">
                 <span className="font-semibold text-lg text-primary mb-2 block">Features</span>
           ...
           <div className="flex flex-wrap -mx-4">
             <div className="w-full md:w-1/2 lg:w-1/4 px-4">
               <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".1s">
                 ...
                 <h4 className="font-bold text-xl text-dark mb-3">Free and Open-Source</h4>
                 <p className="text-body-color mb-8 lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                 <a href="javascript:void(0)" className="font-medium text-base text-body-color hover:text-primary">
                   Learn More
                 </a>
               </div>
             </div>
             <div className="w-full md:w-1/2 lg:w-1/4 px-4">
               <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".15s">
                 <div className=" w-[70px] h-[70px] flex items-center justify-center bg-primary rounded-2xl mb-8 relative z-10 " >
                   <span className=" w-[70px] h-[70px] flex items-center justify-center bg-primary bg-opacity-20 rounded-2xl mb-8 absolute z-[-1] top-0 left-0 rotate-[25deg] group-hover:rotate-45 duration-300 " ></span>
                   <svg width="35" height="35" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
                 ...
                 <h4 className="font-bold text-xl text-dark mb-3">Multipurpose Template</h4>
                 <p className="text-body-color mb-8 lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                 <a href="javascript:void(0)" className="font-medium text-base text-body-color hover:text-primary">
                   Learn More
                 </a>
             ...
             <div className="w-full md:w-1/2 lg:w-1/4 px-4">
               <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".2s">
                 <div className=" w-[70px] h-[70px] flex items-center justify-center bg-primary rounded-2xl mb-8 relative z-10 " >
                   <span className=" w-[70px] h-[70px] flex items-center justify-center bg-primary bg-opacity-20 rounded-2xl mb-8 absolute z-[-1] top-0 left-0 rotate-[25deg] group-hover:rotate-45 duration-300 " ></span>
                 ...
                 <h4 className="font-bold text-xl text-dark mb-3">High-quality Design</h4>
                 <p className="text-body-color mb-8 lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                 <a href="javascript:void(0)" className="font-medium text-base text-body-color hover:text-primary">
                   Learn More
                 </a>
             ...
             <div className="w-full md:w-1/2 lg:w-1/4 px-4">
               <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".25s">
                 <div className=" w-[70px] h-[70px] flex items-center justify-center bg-primary rounded-2xl mb-8 relative z-10 " >
                   <span className=" w-[70px] h-[70px] flex items-center justify-center bg-primary bg-opacity-20 rounded-2xl mb-8 absolute z-[-1] top-0 left-0 rotate-[25deg] group-hover:rotate-45 duration-300 " ></span>
                   <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
                 ...
                 <h4 className="font-bold text-xl text-dark mb-3">All Essential Elements</h4>
                 <p className="text-body-color mb-8 lg:mb-11">Lorem Ipsum is simply dummy text of the printing and industry.</p>
                 <a href="javascript:void(0)" className="font-medium text-base text-body-color hover:text-primary">
                   Learn More
                 </a>
