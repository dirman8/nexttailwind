           ...
           <div className="flex flex-wrap -mx-4">
             <div className="w-full px-4">
               <div className="text-center mx-auto mb-[60px] max-w-[620px]">
                 <span className="font-semibold text-lg text-primary mb-2 block">Our Team</span>
           ...
           <div className="flex flex-wrap justify-center -mx-4">
             <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
               <div className="mb-10 wow fadeInUp" data-wow-delay=".1s">
                 <div className=" relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6 " >
                   <img src="/images/team/team-01.png" alt="image" className="w-full rounded-full" />
                 ...
                 <div className="text-center">
                   <h4 className="font-medium text-lg text-dark mb-2">Adveen Desuza</h4>
                   <p className="font-medium text-sm text-body-color mb-5">UI Designer</p>
                   <div className="flex items-center justify-center">
                     <a href="javascript:void(0)" className=" text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center " >
             ...
             <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
               <div className="mb-10 wow fadeInUp" data-wow-delay=".15s">
                 <div className=" relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6 " >
                   <img src="/images/team/team-02.png" alt="image" className="w-full rounded-full" />
                   <span className="absolute top-0 left-0 z-[-1]">
                     <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                       <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
                 ...
                 <div className="text-center">
                   ...
                   <p className="font-medium text-sm text-body-color mb-5">Product Designer</p>
                   <div className="flex items-center justify-center">
                     <a href="javascript:void(0)" className=" text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center " >
                       <svg width="10" height="18" viewBox="0 0 10 18" className="fill-current">
                         <path d="M9.29878 7.2H7.74898H7.19548V6.61935V4.81936V4.23871H7.74898H8.91133C9.21575 4.23871 9.46483 4.00645 9.46483 3.65806V0.580645C9.46483 0.26129 9.24343 0 8.91133 0H6.89106C4.70474 0 3.18262 1.62581 3.18262 4.03548V6.56129V7.14194H2.62912H0.747223C0.359774 7.14194 0 7.46129 0 7.92581V10.0161C0 10.4226 0.304424 10.8 0.747223 10.8H2.57377H3.12727V11.3806V17.2161C3.12727 17.6226 3.43169 18 3.87449 18H6.47593C6.64198 18 6.78036 17.9129 6.89106 17.7968C7.00176 17.6806 7.08478 17.4774 7.08478 17.3032V11.4097V10.829H7.66596H8.91133C9.2711 10.829 9.54785 10.5968 9.6032 10.2484V10.2194V10.1903L9.99065 8.1871C10.0183 7.98387 9.99065 7.75161 9.8246 7.51935C9.76925 7.37419 9.52018 7.22903 9.29878 7.2Z" />
             ...
             <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
               <div className="mb-10 wow fadeInUp" data-wow-delay=".2s">
                 <div className=" relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6 " >
                   <img src="/images/team/team-03.png" alt="image" className="w-full rounded-full" />
                   <span className="absolute top-0 left-0 z-[-1]">
                     <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)" fill="#3056D3" />
                       <circle cx="12.6747" cy="80.7066" r="1.29337" transform="rotate(-90 12.6747 80.7066)" fill="#3056D3" />
                 ...
                 <div className="text-center">
                   <h4 className="font-medium text-lg text-dark mb-2">Andrieo Gloree</h4>
                   <p className="font-medium text-sm text-body-color mb-5">App Developer</p>
                   <div className="flex items-center justify-center">
                     <a href="javascript:void(0)" className=" text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center " >
                       <svg width="10" height="18" viewBox="0 0 10 18" className="fill-current">
                         <path d="M9.29878 7.2H7.74898H7.19548V6.61935V4.81936V4.23871H7.74898H8.91133C9.21575 4.23871 9.46483 4.00645 9.46483 3.65806V0.580645C9.46483 0.26129 9.24343 0 8.91133 0H6.89106C4.70474 0 3.18262 1.62581 3.18262 4.03548V6.56129V7.14194H2.62912H0.747223C0.359774 7.14194 0 7.46129 0 7.92581V10.0161C0 10.4226 0.304424 10.8 0.747223 10.8H2.57377H3.12727V11.3806V17.2161C3.12727 17.6226 3.43169 18 3.87449 18H6.47593C6.64198 18 6.78036 17.9129 6.89106 17.7968C7.00176 17.6806 7.08478 17.4774 7.08478 17.3032V11.4097V10.829H7.66596H8.91133C9.2711 10.829 9.54785 10.5968 9.6032 10.2484V10.2194V10.1903L9.99065 8.1871C10.0183 7.98387 9.99065 7.75161 9.8246 7.51935C9.76925 7.37419 9.52018 7.22903 9.29878 7.2Z" />
             ...
             <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
               <div className="mb-10 wow fadeInUp" data-wow-delay=".25s">
                 ...
                 <div className="text-center">
                   <h4 className="font-medium text-lg text-dark mb-2">Jackie Sanders</h4>
                   <p className="font-medium text-sm text-body-color mb-5">Content Writer</p>
                   <div className="flex items-center justify-center">
                     <a href="javascript:void(0)" className=" text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center " >
                       <svg width="10" height="18" viewBox="0 0 10 18" className="fill-current">
                         <path d="M9.29878 7.2H7.74898H7.19548V6.61935V4.81936V4.23871H7.74898H8.91133C9.21575 4.23871 9.46483 4.00645 9.46483 3.65806V0.580645C9.46483 0.26129 9.24343 0 8.91133 0H6.89106C4.70474 0 3.18262 1.62581 3.18262 4.03548V6.56129V7.14194H2.62912H0.747223C0.359774 7.14194 0 7.46129 0 7.92581V10.0161C0 10.4226 0.304424 10.8 0.747223 10.8H2.57377H3.12727V11.3806V17.2161C3.12727 17.6226 3.43169 18 3.87449 18H6.47593C6.64198 18 6.78036 17.9129 6.89106 17.7968C7.00176 17.6806 7.08478 17.4774 7.08478 17.3032V11.4097V10.829H7.66596H8.91133C9.2711 10.829 9.54785 10.5968 9.6032 10.2484V10.2194V10.1903L9.99065 8.1871C10.0183 7.98387 9.99065 7.75161 9.8246 7.51935C9.76925 7.37419 9.52018 7.22903 9.29878 7.2Z" />
