         ...
         <div className="container">
           <div className="flex flex-wrap items-center -mx-4">
             <div className="w-full px-4">
               <div className=" hero-content text-center max-w-[780px] mx-auto wow fadeInUp " data-wow-delay=".2s">
                 ...
                 <ul className="flex flex-wrap items-center justify-center mb-10">
                   <li>
                     <a href="https://links.tailgrids.com/play-download" className=" py-4 px-6 sm:px-10 inline-flex items-center justify-center text-center text-dark text-base bg-white hover:text-primary hover:shadow-lg font-medium rounded-lg transition duration-300 ease-in-out ">
                       Download Now
                     </a>
                   </li>
                   <li>
                     <a href="https://github.com/tailgrids/play-tailwind" target="_blank" className=" text-base font-medium text-white py-4 px-6 sm:px-10 flex items-center hover:opacity-70 transition duration-300 ease-in-out ">
                       Star on Github
                       <span className="pl-2">
                 ...
                 <div className="text-center wow fadeInUp" data-wow-delay=".3s">
                   <img src="/images/hero/brand.svg" alt="image" className=" max-w-[250px] w-full mx-auto opacity-50 hover:opacity-100 transition duration-300 ease-in-out " />
                 </div>
               </div>
             </div>
             ...
             <div className="w-full px-4">
               <div className="mx-auto max-w-[845px] relative z-10 wow fadeInUp" data-wow-delay=".25s">
                 <div className="mt-16">
                   <img src="/images/hero/hero-image.jpg" alt="hero" className="max-w-full mx-auto rounded-t-xl rounded-tr-xl" />
                 </div>
